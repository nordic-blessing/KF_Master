<div style="text-align: center;">
    ...
    <h1 style="font-style: italic; margin: 0;">SPLIB</h1>
    <p style="margin: 4px 0;"><b>S</b>ichuan University <b>P</b>angolin <b>Lib</b>rary</p>
    <p style="margin: 4px 0;">四川大学川山甲战队电控组驱动接口库</p>
    <br/>
...
**SPLIB** 为四川大学（Sichuan University） 川山甲战队 `Pangolin` 电控组驱动接口库。本库旨在将战队电控开发过程中常用的底层接口和设备驱动代码，进行模块化封装，简化项目构建流程，避免重复造轮子，提高开发效率。

本项目基于 STM32 HAL库，适用于队内自主设计的主控板、分控板，以及 DM-MC-Board01 等控制板。本库主要由 **板级支持包** 和 **队内常用设备驱动** 两部分构成，队员可通过修改配置文件 `splib_config.h` 对接口库进行裁剪，仅编译所需驱动，或按规范自行扩展其他模块
